...
public class RotateGestureDetector implements View.OnTouchListener {
    ...
    private float mLastX, mLastY; // 记录上次的触摸坐标

    private boolean doOnePointerMove(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // 平移视图
                mDetectorView.setTranslationX(mDetectorView.getTranslationX() + dx);
                mDetectorView.setTranslationY(mDetectorView.getTranslationY() + dy);
